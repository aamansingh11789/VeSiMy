      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: 'clamp(40px,6vw,88px) clamp(20px,5vw,40px)' }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 18 }}>
            <span style={{ fontSize: 10, fontWeight: 800, padding: '3px 10px', borderRadius: 999, background: 'rgba(11,29,51,0.15)', color: '#0B1D33', fontFamily: 'var(--font-mono)', letterSpacing: 1.5 }}>GUIDE</span>
            <span style={{ fontSize: 12, color: '#52507A', fontFamily: 'var(--font-mono)' }}>8 min read · March 12, 2026</span>
          </div>
        ...
        <div style={{ fontSize: 15, color: '#B8B5D1', lineHeight: 1.9 }}>
          ...
          <p style={{ marginBottom: 18 }}>
            Every VSM project starts with a <strong style={{ color: '#0B1D33' }}>current state map</strong>, an honest picture of exactly how your process works today. Not how it's supposed to work. How it actually works.
          </p>
          <p style={{ marginBottom: 18 }}>
            From there, you build a <strong style={{ color: '#0B1D33' }}>future state map</strong>, what the process should look like after you've eliminated the waste you found. The gap between current and future state is your kaizen roadmap.
          </p>
          ...
          {[
            ...
            <div key={term} style={{ background: 'rgba(11,29,51,0.06)', border: '1px solid rgba(11,29,51,0.15)', borderRadius: 10, padding: '14px 18px', marginBottom: 10 }}>
              <span style={{ color: '#0B1D33', fontWeight: 700 }}>{term}:</span> {def}
            </div>
          ))}
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', gap: 16, marginBottom: 20 }}>
              <div style={{ width: 28, height: 28, borderRadius: '50%', background: 'rgba(11,29,51,0.15)', color: '#0B1D33', fontWeight: 800, fontSize: 13, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 2 }}>
                {i + 1}
              </div>
              <div>
          ...
          {/* CTA */}
          <div style={{ marginTop: 48, padding: '32px 36px', background: 'rgba(11,29,51,0.06)', border: '1px solid rgba(11,29,51,0.2)', borderRadius: 16, textAlign: 'center' }}>
            ...
            <Link href="/auth/signup" style={{ padding: '12px 28px', background: 'linear-gradient(135deg,#0a5eaa,#0B1D33)', color: 'var(--bg)', fontWeight: 700, fontSize: 14, borderRadius: 10, textDecoration: 'none' }}>
              Build your VSM free →
            </Link>
          </div>
        </div>
