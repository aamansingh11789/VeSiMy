      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: 'clamp(40px,6vw,88px) clamp(20px,5vw,40px)' }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 18 }}>
            <span style={{ fontSize: 10, fontWeight: 800, padding: '3px 10px', borderRadius: 999, background: 'rgba(212,162,8,0.12)', color: '#D4A208', fontFamily: 'monospace', letterSpacing: 1.5 }}>TOOL GUIDE</span>
        ...
        <div style={{ fontSize: 15, color: 'var(--text2)', lineHeight: 1.9 }}>
          ...
          {[
            ...
            <div key={item.stage} style={{ background: 'rgba(212,162,8,0.05)', border: '1px solid rgba(212,162,8,0.2)', borderRadius: 12, padding: '18px 20px', marginBottom: 16 }}>
          ...
          {[
            ...
            <div key={term} style={{ display: 'flex', gap: 14, marginBottom: 14 }}>
              <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#D4A208', marginTop: 9, flexShrink: 0 }} />
              <div>
