      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: 'clamp(40px,6vw,88px) clamp(20px,5vw,40px)' }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 18 }}>
            <span style={{ fontSize: 10, fontWeight: 800, padding: '3px 10px', borderRadius: 999, background: 'rgba(108,185,252,0.12)', color: '#6CB9FC', fontFamily: 'monospace', letterSpacing: 1.5 }}>COMPARISON</span>
        ...
        <div style={{ fontSize: 15, color: 'var(--text2)', lineHeight: 1.9 }}>
          ...
          <div style={{ background: 'rgba(29,209,161,0.06)', border: '1px solid rgba(29,209,161,0.2)', borderRadius: 12, padding: '20px 24px', marginTop: 32 }}>
            ...
            <p style={{ margin: '0 0 16px', fontSize: 14, lineHeight: 1.7 }}>Unlimited projects, all 9 CI tools, no credit card. See what a connected CI system actually feels like on a real process.</p>
