      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: 'clamp(40px,6vw,88px) clamp(20px,5vw,40px)' }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 18 }}>
            <span style={{ fontSize: 10, fontWeight: 800, padding: '3px 10px', borderRadius: 999, background: 'rgba(11,29,51,0.15)', color: '#0B1D33', fontFamily: 'var(--font-mono)', letterSpacing: 1.5 }}>AUTOMOTIVE</span>
        ...
        <div style={{ fontSize: 15, color: '#4E4B45', lineHeight: 1.9 }}>
          ...
          <div style={{ borderLeft: '3px solid #0B1D33', paddingLeft: 20, marginBottom: 24 }}>
