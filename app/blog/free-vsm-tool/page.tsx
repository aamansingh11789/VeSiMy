        ...
        <div style={{ fontSize: 15, color: '#B8B5D1', lineHeight: 1.9 }}>
          ...
          {[
            ...
            <div key={tool.name} style={{
              background: tool.highlight ? 'rgba(11,29,51,0.06)' : 'rgba(248,247,245,0.97)',
              border: `1px solid ${tool.highlight ? 'rgba(11,29,51,0.25)' : 'rgba(44,44,92,0.6)'}`,
              borderRadius: 14, padding: '24px 26px', marginBottom: 16,
            }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12, flexWrap: 'wrap', gap: 8 }}>
                <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                  <span style={{ fontWeight: 800, fontSize: 17, color: tool.highlight ? '#0B1D33' : 'var(--text)' }}>{tool.name}</span>
                  {tool.highlight && <span style={{ fontSize: 9, background: '#0B1D33', color: 'var(--bg)', padding: '2px 8px', borderRadius: 999, fontWeight: 800, letterSpacing: 1 }}>RECOMMENDED</span>}
                </div>
                <span style={{ fontSize: 13, color: tool.highlight ? '#0B1D33' : 'var(--text2)', fontFamily: 'var(--font-mono)' }}>{tool.price}</span>
              </div>
          ...
          <div style={{ padding: '32px 36px', background: 'rgba(11,29,51,0.06)', border: '1px solid rgba(11,29,51,0.2)', borderRadius: 16, textAlign: 'center' }}>
