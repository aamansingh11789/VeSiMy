    ...
    <div style={{ minHeight: '100vh', color: '#EAE8F4' }}>
      <div style={{ maxWidth: 720, margin: '0 auto', padding: 'clamp(40px,6vw,88px) clamp(20px,5vw,40px)' }}>
        ...
        <div style={{ fontSize: 15, color: '#B8B5D1', lineHeight: 1.9 }}>
          ...
          <h2 style={{ fontFamily: serif, fontSize: 24, fontWeight: 700, color: '#F3F1FB', margin: '40px 0 14px' }}>What Standard Work is — and what it is not</h2>
          <p style={{ marginBottom: 18 }}>
            Standard Work is the documented current best method for performing a specific process task. Not the fastest possible method. Not the theoretically optimal method. The <em style={{ color: '#F3F1FB' }}>current</em> best method — the safest, highest quality, lowest waste approach that any trained operator can reliably replicate right now.
          </p>
          <p style={{ marginBottom: 18 }}>
          ...
          <div style={{ background: 'rgba(108,185,252,0.06)', border: '1px solid rgba(108,185,252,0.2)', borderRadius: 12, padding: '20px 24px', marginBottom: 24 }}>
            <p style={{ margin: 0, fontStyle: 'italic', fontSize: 15, color: '#F3F1FB', lineHeight: 1.7 }}>
            ...
            <p style={{ margin: '10px 0 0', fontSize: 12, color: '#8B88B3' }}>— Taiichi Ohno, Toyota Production System</p>
          </div>

          <h2 style={{ fontFamily: serif, fontSize: 24, fontWeight: 700, color: '#F3F1FB', margin: '40px 0 14px' }}>The three Standard Work documents</h2>
          ...
          {[
            ...
            <div key={title} style={{ background: 'rgba(8,8,24,0.78)', border: `1px solid ${color}33`, borderRadius: 12, padding: '18px 20px', marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 12, color: '#7070A0' }}><strong style={{ color: color }}>Use for:</strong> {use}</div>
            </div>
          ))}

          <h2 style={{ fontFamily: serif, fontSize: 24, fontWeight: 700, color: '#F3F1FB', margin: '40px 0 14px' }}>The most important rule: Standard Work lives at the workstation</h2>
          <p style={{ marginBottom: 18 }}>
          ...
          <h2 style={{ fontFamily: serif, fontSize: 24, fontWeight: 700, color: '#F3F1FB', margin: '40px 0 14px' }}>Standard Work and PDCA: the improvement loop</h2>
          <p style={{ marginBottom: 18 }}>
