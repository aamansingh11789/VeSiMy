      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: 'clamp(40px,6vw,88px) clamp(20px,5vw,40px)' }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 18 }}>
            ...
            <span style={{ fontSize: 12, color: '#52507A', fontFamily: 'monospace' }}>5 min read · April 2026</span>
          </div>
        ...
        <div style={{ fontSize: 15, color: 'var(--text2)', lineHeight: 1.9 }}>
          ...
          <p style={{ marginBottom: 18 }}>L = λW. Where L is the average number of items in the system (WIP), λ is the average arrival rate (throughput), and W is the average time an item spends in the system (lead time). Rearranged: Lead time = WIP / Throughput.</p>
          ...
          <p style={{ marginBottom: 18 }}>If your WIP is 120 units, your throughput is 30 units per day, and your measured lead time is 5 days, something is wrong. The formula says lead time should be 4 days. Before trusting any VSM analysis, verify that your WIP, throughput, and lead time reconcile through Little's Law.</p>
          ...
          <h2 style={{ fontFamily: serif, fontSize: 24, fontWeight: 700, color: 'var(--text)', margin: '40px 0 14px' }}>Using it to see the leverage</h2>
