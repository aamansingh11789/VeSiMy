      ...
      <div style={{ maxWidth:420, width:'100%' }}>
        ...
        {sent ? (
          <div style={{ background:'rgba(8,8,24,0.9)', border:'1px solid rgba(29,209,161,0.25)', borderRadius:16, padding:'36px 32px', textAlign:'center' }}>
            ...
            <h2 style={{ fontFamily:serif, fontSize:22, fontWeight:700, color:'#EAE8F4', marginBottom:10 }}>Check your inbox</h2>
            <p style={{ fontSize:14, color:'#7070A0', lineHeight:1.7, marginBottom:24 }}>
              A reset link was sent to <strong style={{ color:'#EAE8F4' }}>{email}</strong>. Check your spam folder if it doesn't arrive within a minute.
            </p>
            <Link href="/auth/login" style={{ textDecoration:'none', fontSize:13, color:'#7070A0', display:'inline-flex', alignItems:'center', gap:6 }}>
          ...
          <div style={{ background:'rgba(8,8,24,0.9)', border:'1px solid rgba(40,40,92,0.5)', borderRadius:16, padding:'36px 32px' }}>
            <h2 style={{ fontFamily:serif, fontSize:24, fontWeight:700, color:'#EAE8F4', marginBottom:8 }}>Reset your password</h2>
            <p style={{ fontSize:14, color:'#7070A0', marginBottom:28, lineHeight:1.6 }}>
              Enter the email you signed up with and we'll send a reset link.
            </p>
            <div style={{ marginBottom:16 }}>
              <label style={{ fontSize:12, color:'#7070A0', letterSpacing:0.5, display:'block', marginBottom:6 }}>EMAIL</label>
            ...
            <div style={{ textAlign:'center', marginTop:20 }}>
              <Link href="/auth/login" style={{ textDecoration:'none', fontSize:13, color:'#38385C', display:'inline-flex', alignItems:'center', gap:5 }}>
