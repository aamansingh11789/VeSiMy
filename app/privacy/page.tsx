    ...
    <div style={{ minHeight: '100vh', background: '#03030D' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '60px 24px 80px' }}>
        <div style={{ marginBottom: 48 }}>
          ...
          <h1 style={{ fontFamily: 'Palatino Linotype,serif', fontSize: 40, fontWeight: 700, color: '#EAE8F4', marginBottom: 12 }}>Privacy Policy</h1>
        ...
        <div style={{ borderTop: '1px solid rgba(26,26,64,0.5)', paddingTop: 24, display: 'flex', gap: 24, flexWrap: 'wrap' }}>
          <Link href="/terms"   style={{ fontSize: 13, color: '#7070A0', textDecoration: 'none' }}>Terms of Service</Link>
