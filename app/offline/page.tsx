  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui, sans-serif', padding: 24 }}>
      <div style={{ textAlign: 'center', maxWidth: 400 }}>
        <div style={{ fontSize: 28, fontWeight: 700, color: '#0B1D33', marginBottom: 8 }}>VeSiMy</div>
        ...
        <div style={{ fontSize:11, fontWeight:800, fontFamily:"'JetBrains Mono',monospace", letterSpacing:2, color:"var(--text3)", marginBottom:24, opacity:0.6 }}>OFFLINE</div>
        ...
        <a href="/dashboard" style={{ display: 'inline-block', background: '#0B1D33', color: '#FFFFFF', fontWeight: 700, fontSize: 14, padding: '12px 28px', borderRadius: 8, textDecoration: 'none' }}>
          Try again
        </a>
      </div>
    </div>
