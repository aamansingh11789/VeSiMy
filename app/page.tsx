      ...
      {showPromo && (
        <div style={{ padding: '0 clamp(16px,4vw,48px)', background: '#F8F6F0' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '24px 0' }}>
            <div style={{ background: 'rgba(196,155,46,0.08)', border: '1px solid rgba(196,155,46,0.3)', borderRadius: 10, padding: '14px 18px', display: 'flex', alignItems: 'center', gap: 14, flexWrap: 'wrap' }}>
              ...
              <button onClick={copyPromoCode} style={{ padding: '7px 14px', borderRadius: 8, border: '1px solid #D8D5CE', background: '#fff', cursor: 'pointer', fontSize: 13, color: '#6B6760', fontWeight: 600 }}>Copy code</button>
