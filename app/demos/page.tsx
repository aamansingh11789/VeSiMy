    ...
    <div style={{ minHeight: '100vh', background: '#F8F6F0', fontFamily: 'Arial, sans-serif' }}>
      ...
      <nav style={{ background: '#242220', padding: '0 clamp(16px,4vw,48px)', height: 56, display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 100 }}>
        <Link href="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 10 }}>
          <span style={{ fontSize: 20, fontWeight: 800, color: '#C49B2E', fontFamily: serif }}>VeSiMy</span>
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
          ...
          <Link href="/auth/signup" style={{ background: '#C49B2E', color: '#0D0C0A', padding: '7px 16px', borderRadius: 8, fontSize: 13, fontWeight: 700, textDecoration: 'none' }}>
            Start free →
          </Link>
        </div>
      </nav>
      ...
      {/* Hero */}
      <div style={{ background: '#242220', padding: 'clamp(48px,6vw,80px) clamp(16px,4vw,48px)', textAlign: 'center', borderBottom: '3px solid #C49B2E' }}>
        <div style={{ fontSize: 11, color: '#C49B2E', letterSpacing: 2.5, textTransform: 'uppercase', fontFamily: 'monospace', fontWeight: 700, marginBottom: 16 }}>Live Demo Projects</div>
      ...
      <div style={{ maxWidth: 1060, margin: '0 auto', padding: 'clamp(40px,5vw,64px) clamp(16px,4vw,48px)' }}>
          ...
          {DEMOS.map((demo, i) => (
            <div key={demo.slug} style={{ background: '#FFFFFF', border: '0.5px solid #D8D5CE', borderRadius: 16, overflow: 'hidden', display: 'grid', gridTemplateColumns: '1fr auto', gap: 0 }}>
              <div style={{ padding: 'clamp(24px,3vw,36px)', borderRight: '0.5px solid #D8D5CE' }}>
                ...
                {/* Key insight */}
                <div style={{ padding: '10px 14px', background: 'rgba(196,155,46,0.06)', border: '1px solid rgba(196,155,46,0.2)', borderRadius: 8, borderLeft: `3px solid #C49B2E` }}>
                  <span style={{ fontSize: 10, color: '#C49B2E', fontFamily: 'monospace', fontWeight: 700 }}>ROOT CAUSE FINDING: </span>
        ...
        <div style={{ textAlign: 'center', marginTop: 56, padding: '40px 24px', background: '#242220', borderRadius: 16, border: '0.5px solid #353330' }}>
          <div style={{ fontSize: 11, color: '#C49B2E', letterSpacing: 2, textTransform: 'uppercase', fontFamily: 'monospace', marginBottom: 12 }}>Your industry</div>
          ...
          <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/auth/signup" style={{ padding: '12px 24px', background: '#C49B2E', color: '#0D0C0A', borderRadius: 10, fontSize: 14, fontWeight: 700, textDecoration: 'none' }}>
      ...
      <div style={{ textAlign: 'center', padding: '24px 16px', borderTop: '0.5px solid #D8D5CE', color: '#8E8A82', fontSize: 12 }}>
        <Link href="/" style={{ color: '#C49B2E', textDecoration: 'none', fontWeight: 700 }}>VeSiMy</Link>
