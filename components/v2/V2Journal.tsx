...
function renderSection(title: string, rows: [string, string][], color = '#C9A66B') {
  return `
    <div class="section">
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .header { border-bottom: 3px solid #C9A66B; padding-bottom: 18px; margin-bottom: 28px; }
    ...
    .action-num { width: 20px; height: 20px; border-radius: 50%; background: #C9A66B; color: white; display: inline-flex; align-items: center; justify-content: center; font-size: 9px; font-weight: 700; flex-shrink: 0; margin-top: 1px; }
    @media print {
      body { padding: 20px; }
...
<body>
  <p class="no-print" style="background:#EEF4FB;border:1px solid #C9A66B;border-radius:6px;padding:8px 14px;font-size:11px;color:#C9A66B;margin-bottom:20px;">
      ...
      <div style={{
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
            ...
            {ip.conservative && (
              <span style={{ fontSize: 11, fontFamily: 'var(--font-mono)', padding: '3px 8px', borderRadius: 5, background: 'rgba(46,132,74,.08)', color: GREEN, border: '1px solid rgba(46,132,74,.2)' }}>
                ↑ {ip.conservative}
              </span>
            )}
          </div>
          ...
          <div style={{ borderTop: '1px solid var(--border)', padding: '16px 18px' }}>
            ...
            {isFuture && report.target_achievement && (
              <div style={{ padding: '12px 14px', background: 'rgba(46,132,74,.05)', border: '1px solid rgba(46,132,74,.2)', borderRadius: 8, marginBottom: 14 }}>
                <div style={{ fontSize: 9, fontFamily: 'var(--font-mono)', color: GREEN, letterSpacing: 1.5, marginBottom: 6 }}>TARGET ASSESSMENT</div>
    ...
    <div style={{ flex: 1, overflowY: 'auto', padding: 28 }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ marginBottom: 28 }}>
          <div style={{ fontSize: 9, fontFamily: 'var(--font-mono)', letterSpacing: 2, color: 'var(--text3)', marginBottom: 6 }}>PROCESS JOURNAL</div>
        ...
        {futureReports.length > 0 && (
          <div style={{ marginBottom: 24 }}>
            <div style={{ fontSize: 9, fontFamily: 'var(--font-mono)', letterSpacing: 2, color: GREEN, marginBottom: 12 }}>FUTURE STATE REPORTS</div>
        ...
        {currentReports.length > 0 && (
          <div>
            <div style={{ fontSize: 9, fontFamily: 'var(--font-mono)', letterSpacing: 2, color: BRAND, marginBottom: 12 }}>CURRENT STATE REPORTS</div>
