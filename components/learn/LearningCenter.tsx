...
const MANUAL = [
  ...
  { id:'tool-stopwatch', icon:'⏱', title:'Tool 1 — Time Study', pro:false, steps:[
    ...
    { title:'How to use it', body:'Click ⏱ on any step card. Press Start to begin timing, Lap to record each cycle. After 10+ observations, click Save. The mean of valid laps becomes the official cycle time. You can also manually enter a known time if using historical data.' },
  ...
  { id:'tool-waste', icon:'⚠️', title:'Tool 4 — Waste Identification (DOWNTIME)', pro:false, steps:[
  ...
  { id:'vsm', icon:'🗺️', title:'VSM Map', pro:false, steps:[
    ...
    { title:'VSM analysis toolbar', body:'Three buttons above the map: 🎯 Gap Analysis & AI Coaching (finds every lean gap), 📊 Yamazumi Chart (operator balance), 📋 Standard Work Sheet (task documentation). These are the tools that transform a VSM from a diagram into an improvement engine.' },
