...
const PHASE_CFG = [
  ...
  { key: 'do',   label: 'Do',   color: '#C9A66B', icon: '', desc: 'Implement countermeasures on a small scale' },
  { key: 'check',label: 'Check',color: '#1DD1A1', icon: '', desc: 'Measure results against the target' },
  { key: 'act',  label: 'Act',  color: '#A8854F', icon: '', desc: 'Standardise success or loop back to Plan' },
]
