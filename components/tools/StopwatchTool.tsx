      ...
      <div style={{ display: 'grid', gap: 12 }}>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 8, justifyContent: 'center', flexWrap: 'wrap', marginTop: 10 }}>
            ...
            {running && (
              <button onClick={lap} className="btn btn-ghost btn-sm" style={{ minWidth: 80 }}>
                ⏱ Lap
              </button>
            )}

            {laps.length > 0 && !running && (
              <button onClick={reset} className="btn btn-ghost btn-sm" style={{ minWidth: 80 }}>
                ↺ Reset
              </button>
            )}
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
            {[
              ...
              >
                ...
                <div style={{ fontSize: 14, fontWeight: 700, color: '#D4A208' }}>{val}</div>
              </div>
            ))}
          </div>
        )}
